# Generated by Django 3.1.2 on 2020-12-15 06:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Status', models.CharField(choices=[('REJECTED', 'rejected'), ('SHORTLISTED', 'shortlisted'), ('PENDING', 'pending')], default='PENDING', max_length=20)),
